...
python PES_cs_Fusion2.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 0 --num_epochs 200  --T1 29 --TStop_PH 40 #--TStop_AM 30 
python PES_cs_Fusion2.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 0 --num_epochs 200  --T1 28 --TStop_PH 40 #--TStop_AM 30
python PES_cs_Fusion2.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 0 --num_epochs 200  --T1 27 --TStop_PH 40 #--TStop_AM 30 
python PES_cs_Fusion2.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 0 --num_epochs 200  --T1 18 --TStop_PH 40 #--TStop_AM 30 
python PES_cs_Fusion2.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 0 --num_epochs 200  --T1 17 --TStop_PH 40 #--TStop_AM 30
