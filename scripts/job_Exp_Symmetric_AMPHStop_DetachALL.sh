...
python PES_cs_Fusion2_DetaALL.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 1 --num_epochs 180  --T1 19 --TStop_PH 39 #--TStop_AM 30
python PES_cs_Fusion2_DetaALL.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 2 --num_epochs 180  --T1 19 --TStop_PH 39 
python PES_cs_Fusion2_DetaALL.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 3 --num_epochs 180  --T1 19 --TStop_PH 39 
python PES_cs_Fusion2_DetaALL.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 4 --num_epochs 180  --T1 19 --TStop_PH 39 
python PES_cs_Fusion2_DetaALL.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 5 --num_epochs 180  --T1 19 --TStop_PH 39 
python Cal_Mean.py --Max_t 5 --noise_type symmetric --noise_rate 0.5 --T1 19 --exp ALL
