...
python PES_cs_Fusion2.py --dataset cifar10 --noise_type pairflip --noise_rate 0.45 --seed 6 --num_epochs 200  --T1 19 --TStop_PH 39 #--TStop_AM 30
python PES_cs_Fusion2.py --dataset cifar10 --noise_type pairflip --noise_rate 0.45 --seed 7 --num_epochs 200  --T1 19 --TStop_PH 39 #--TStop_AM 30
python PES_cs_Fusion2.py --dataset cifar10 --noise_type pairflip --noise_rate 0.45 --seed 8 --num_epochs 200  --T1 19 --TStop_PH 39 #--TStop_AM 30
python PES_cs_Fusion2.py --dataset cifar10 --noise_type pairflip --noise_rate 0.45 --seed 9 --num_epochs 200  --T1 19 --TStop_PH 39 #--TStop_AM 30
python PES_cs_Fusion2.py --dataset cifar10 --noise_type pairflip --noise_rate 0.45 --seed 10 --num_epochs 200  --T1 19 --TStop_PH 39 #--TStop_AM 30
