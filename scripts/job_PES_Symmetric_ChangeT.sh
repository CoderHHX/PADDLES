...
python PES_cs2_new.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 6 --num_epochs 100  --T1 30 --T2 15 
python PES_cs2_new.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 7 --num_epochs 100  --T1 30 --T2 15 
python PES_cs2_new.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 8 --num_epochs 100  --T1 30 --T2 15 
python PES_cs2_new.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 9 --num_epochs 100  --T1 30 --T2 15 
python PES_cs2_new.py --dataset cifar10 --noise_type symmetric --noise_rate 0.5 --seed 10 --num_epochs 100  --T1 30 --T2 15 
# ############################
