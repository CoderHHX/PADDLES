...
from networks.ResNet_New_DetachB4B5 import PreActResNet18
...
parser.add_argument('--TStop_PH', default=35, type=int, help='Stop epochs of PH training')
...
if args.dataset == 'cifar10' or args.dataset == 'CIFAR10':
    ...
    transform_train = transforms.Compose(
        [
            transforms.RandomCrop(32, padding=4),
            transforms.RandomHorizontalFlip(),
            # CIFAR10Policy(), #No Aug on V30 77.52     # Aug on V23
            transforms.ToTensor(),
...
write_logs("SemiNewest:", args, best_test_acc)

np_acc = np.array(acc_list)
save_name = 'npy/' + str(args.seed) + '_' + args.noise_type + str(args.noise_rate) + "_" + str(args.TStop_AM)+ "-" + str(args.TStop_PH) + args.dataset + '_PADDLES_Semi.npy'
