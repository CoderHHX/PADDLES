...
class Train_Dataset(Dataset):
    def __init__(self, data, labels, transform=None, target_transform=None, is_img=True):
    ...
    def __getitem__(self, index):
        ...
        if self.is_img: img = Image.fromarray(img)
...
class Semi_Unlabeled_Dataset(Dataset):
    def __init__(self, data, transform=None, is_img=True):
        self.train_data = np.array(data)
